      ...
      <>
        ...
        >
          <List sx={{ background: 'linear-gradient(90deg,#f5f5dc, #12372A 120%)' }}>
            <ListItem button component={Link} to="/" onClick={closeDrawer} style={listItemStyles}>
              <ListItemText primary="Home" />
            </ListItem>
            <ListItem button component={Link} to="/shop" onClick={closeDrawer} style={listItemStyles}>
              <ListItemText primary="Shop" />
            </ListItem>
            <ListItem button component={Link} to="/about" onClick={closeDrawer} style={listItemStyles}>
              <ListItemText primary="About" />
            </ListItem>
            <ListItem button component={Link} to="/contact" onClick={closeDrawer} style={listItemStyles}>
          ...
          <List sx={{ background: 'linear-gradient(90deg,#f5f5dc, #12372A 120%)' }}>
            {isUserAuthenticated ? (
              <>
                <ListItem button component={Link} to={`/userdetails/${userDetails._id}`} onClick={closeDrawer} style={listItemStyles}>
                  <ListItemText primary="My Account" />
                </ListItem>
                <ListItem button component={Link} to="/placedorders" onClick={closeDrawer} style={listItemStyles}>
                  <ListItemText primary="My Orders" />
                </ListItem>
                <ListItem button component={Link} to="/cart" onClick={closeDrawer} style={listItemStyles}>
                  <ListItemText primary="My Cart" />
                </ListItem>
                <ListItem button onClick={() => { handleLogout(); closeDrawer(); }} style={listItemStyles}>
                  <ListItemText primary="Logout" />
                </ListItem>
              </>
            ) : (
              <ListItem button component={Link} to="/login" onClick={closeDrawer} style={listItemStyles}>
